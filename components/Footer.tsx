            ...
            <div className="flex items-center gap-3 flex-wrap">
               ...
               {/* INSTAGRAM */}
                ...
                <a 
                    ...
                    className="p-2.5 rounded-full bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 hover:border-green-500 hover:text-green-500 transition-colors flex items-center justify-center"
                >
                    <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
              ...
              <ul className={`space-y-4 text-sm ${isIndic ? 'leading-loose' : ''}`}>
                ...
                <li>
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Support via Razorpay"
                    className="group flex items-center gap-2 hover:text-blue-500 transition-colors font-semibold"
                  >
                    <svg 
                      viewBox="0 0 24 24" 
                      className="w-4 h-4 text-gray-400 group-hover:text-blue-500 transition-colors fill-none stroke-current stroke-2" 
                      xmlns="http://www.w3.org/2000/svg"
                    >
