...
export const config = {
  matcher: [
     ...
     */
    '/((?!api|_next/static|_next/image|favicon.ico|sounds|images|models|google.*\\.html|notificationCommandCentre|sitemap.xml|robots.txt|manifest.json|sw.js|custom-sw.js|custom-sw-logic|workbox-|worker-|.*\\.(?:svg|png|jpg|jpeg|gif|webp|mp3|wav|glb|gltf)$).*)',
  ],
};